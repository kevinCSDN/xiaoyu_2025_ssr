...
# 删除不需要的依赖包
rm -rf package/small/{brook,dns2tcp,gn,luci-app-bypass,luci-app-fchomo,luci-app-homeproxy,luci-app-mihomo,luci-app-mosdns,luci-app-openclash,luci-app-passwall2,mihomo,mosdns,pdnsd-alt,redsocks2,shadow-tls,ssocks,trojan-go,v2dat,v2raya}
